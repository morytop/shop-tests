...
**Status:** approved plan (2026-08-16); Phase 0 implemented, Phases 1–6 pending. Phases are sized to one PR each and are independent enough to land in order 0 → 6.
