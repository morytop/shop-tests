...
**Status:** approved plan (2026-08-16); Phases 0–4 implemented, Phases 5–6 pending. Phases are sized to one PR each and are independent enough to land in order 0 → 6.
